import 'package:FeSekka/ui/provider_reqeust_screens/provider_request_detailed_screen.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:flutter/material.dart';
import '../../model/provider_request_list_model.dart';

class ProviderRequestListCell extends StatelessWidget {
  const ProviderRequestListCell({ required this.carData});
      ...
      child: InkWell(
        onTap: (){
          Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => ProviderRequestDetailedScreen(carData: carData,),
          ));
        },
        child: Padding(
